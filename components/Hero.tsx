          ...
          <div className="text-white">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <Button 
                ...
                variant="secondary" 
                className="group"
                onClick={() => navigateToCategory("PCs Gaming")}
              >
                Ver PCs Gaming
              ...
              <Button 
                size="lg" 
                variant="outline" 
                className="border-white text-white hover:bg-white hover:text-purple-600 bg-white/10 backdrop-blur-sm"
                onClick={() => navigateToCategory("Componentes")}
              >
